...
const Expenses2 = () => {
  ...
  const [rows, setRows] = React.useState([
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Bank charges", amount: "$600", status: "Sent", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Bank charges", amount: "$600", status: "Draft", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Conference fees", amount: "$600", status: "Sent", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Consultancy fees", amount: "$600", status: "Draft", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Hardware purchases", amount: "$600", status: "Sent", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Bank charges", amount: "$600", status: "Draft", actions: <BsThreeDotsVertical /> },
    { Checkbox: "terms", date: "06/11/23", expenseNumber: "ESP-002", merchantName: "Marvin McKinney", expenseCategory: "Entertainment", amount: "$600", status: "Sent", actions: <BsThreeDotsVertical /> }
  ]);
            ...
            <div className="flex justify-start gap-7 p-4">
                <div>
                    ...
                    >
                        ...
                        <option value="sendEmail">With receipts</option>
                        <option value="suspendCustomer">Without receipts</option>
                    </select>
                ...
                <div>
                    <Button variant="outline" className=' bg-white text-grey rounded'>
                        <Link href="#">Import Expenses</Link>
                    </Button>
                </div>
            ...
            <table className="min-w-full border border-gray-200 text-xs">
                <thead>
                    <tr>
                        ...
                        <th className="px-6 py-3 text-left font-light">Expense Number</th>
                        <th className="px-6 py-3 text-left font-light">Customer Name</th>
                        <th className="px-6 py-3 text-left font-light">Expense Category</th>
                    ...
                    {rows.map((row, idx) => {
                        return (
                            <tr key={idx}>
                                ...
                                <td className="px-6 py-4">{row.expenseNumber}</td>
                                <td className="px-6 py-4">{row.merchantName}</td>
                                <td className="px-6 py-4">{row.expenseCategory}</td>
