...
const NewItem5 = () => {
  ...
  return (
    <InvoiceBody>
      ...
      <div
        className={`${alegreya_sans.className} h-[863px] bg-[#fafafa] rounded-[8px]  p-8`}
      >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-[170px]  rounded-[4px] flex flex-col gap-1 bg-[#fafafa] shadow-lg">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className=" w-[716px] rounded-[8px] bg-[#fafafa] py-8  flex flex-col gap-6">
                      <div className="flex justify-between border-b-solid border-b-[1px] border-b-[#e6e9ea]">
